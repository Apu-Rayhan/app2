...
const Login = () => {
  return (
    <div className="main border  ">
        ...
        <div className="log border bg-slate-600 w-3/6 rounded-xl m-auto p-10 ">
              <form>
          <div className="mb-6">
            <label
              for="email"
    ...
    <div className="form-group mb-6">
      <label for="exampleInputEmail2" className="form-label inline-block mb-2 text-gray-900">Email address</label>
